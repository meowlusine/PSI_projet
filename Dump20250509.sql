...
INSERT INTO `client` VALUES (1,12,'particulier'),(2,3,'particulier'),(3,4,'entreprise'),(4,5,'particulier'),(5,7,'particulier'),(6,10,'entreprise'),(7,13,'particulier'),(8,14,'particulier'),(9,15,'particulier'),(10,16,'entreprise'),(11,17,'particulier'),(12,19,'entreprise');
...
INSERT INTO `commande` VALUES (1,1,6,'validée','2020-03-05 08:15:54',8),(2,2,7,'validée','2021-06-09 17:54:21',7),(3,3,8,'validée','2025-01-18 21:16:04',2),(4,1,9,'validée','2024-12-26 09:04:43',4),(5,2,10,'validée','2024-10-14 16:31:57',11);
...
INSERT INTO `plat` VALUES (1,'Raclette',10,6,'plat','2025-05-02','2025-05-15','Française','France','raclette, pommes de terre, jambon, cornichon',1,NULL,NULL),(2,'Salade de fruits',5,6,'dessert','2025-05-01','2025-05-09','Végétarien','Indifférent','fraise, kiwi, sucre',1,NULL,NULL),(3,'Pizza Margherita',8.5,10,'plat','2025-02-01','2025-02-05','Italienne','Italie','pâte, sauce tomate, mozzarella, basilic',2,NULL,NULL),(4,'Boeuf Bourguignon',12,5,'plat','2025-02-02','2025-02-10','Française','France','bœuf, vin rouge, champignons, carottes, oignons',3,NULL,NULL),(5,'Tarte aux pommes',6,8,'dessert','2021-02-03','2021-02-07','Végétarien','France','pommes, pâte brisée, cannelle, sucre',1,NULL,NULL),(6,'Quiche Lorraine',7.5,7,'plat','2025-02-04','2025-02-08','Française','France','pâte, lardons, crème, œufs, fromage',2,NULL,NULL),(7,'Crème brûlée',5.5,10,'dessert','2025-02-05','2025-02-12','Végétarien','France','crème, sucre, œufs, vanille',3,NULL,NULL),(8,'Sushi',12,8,'plat','2025-03-10','2025-03-15','Pescetarien','Japon','riz, poisson cru, algues, wasabi',4,NULL,NULL),(9,'Ratatouille',9,10,'plat','2020-03-12','2020-03-18','Végétarien','France','aubergine, courgette, tomate, poivron, herbes de Provence',2,NULL,NULL),(10,'Falafel',7,12,'plat','2025-03-11','2025-03-17','Végétarien','Moyen-Orient','pois chiches, épices, tahini, pita',5,NULL,NULL),(11,'Tacos',8,9,'plat','2025-03-13','2025-03-20','Omnivore','Mexique','tortilla, viande assaisonnée, salsa, fromage, guacamole',3,NULL,NULL),(12,'Panna Cotta',6.5,8,'dessert','2022-03-14','2022-03-21','Végétarien','Italie','crème, sucre, gélatine, vanille, coulis de fruits',4,NULL,NULL),(13,'Biryani',11,6,'plat','2025-03-15','2025-03-22','Omnivore','Inde','riz, épices, poulet, yaourt, coriandre',6,NULL,NULL),(14,'Pad Thaï',10.5,7,'plat','2025-03-16','2025-03-23','Omnivore','Thaïlande','nouilles de riz, crevettes, tofu, cacahuètes, citron vert',5,NULL,NULL),(15,'Baklava',5,10,'dessert','2025-03-17','2025-03-24','Végétarien','Turquie','pâte filo, noix, miel, sirop',7,NULL,NULL),(16,'Ceviche',13,5,'plat','2025-03-18','2025-03-25','Pescetarien','Pérou','poisson cru, citron vert, oignon, coriandre, piment',4,NULL,NULL),(17,'Goulash',9.5,8,'plat','2025-04-28','2025-05-12','Omnivore','Hongrie','bœuf, paprika, oignon, tomate, bouillon',3,NULL,NULL);
...
-- Dump completed on 2025-05-09 15:16:07

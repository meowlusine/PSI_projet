...
public class PSI_Mysql_C_Data
{
    ...
    public PSI_Mysql_C_Data()
    {
        ...
        string Peuplement_commande = "INSERT INTO commande (id_cuisinier, id_client)" +
           "\r\nVALUES (1, 6),(2, 7),(3, 8), (1, 9),(2, 10);";
        ...
        // Module e Cuisinier de l’interface

        string requete = "SELECT DISTINCT u.id_utilisateur, u.nom, u.prenom, u.email FROM commande c JOIN client cl " +
            "ON c.id_client = cl.id_client JOIN utilisateur u ON cl.id_utilisateur = u.id_utilisateur WHERE c.id_cuisinier =  ?;";


        MySqlCommand command12 = maConnexion.CreateCommand();
        command10.CommandText = requete;
